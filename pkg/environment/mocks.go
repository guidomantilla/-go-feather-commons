...
func (mr *MockEnvironmentMockRecorder) AppendPropertySources(propertySources ...interface{}) *gomock.Call {
...
func (mr *MockEnvironmentMockRecorder) GetValue(property interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEnvironmentMockRecorder) GetValueOrDefault(property, defaultValue interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
