...
func (mr *MockPropertiesMockRecorder) Add(property, value interface{}) *gomock.Call {
...
func (mr *MockPropertiesMockRecorder) Get(property interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockPropertySourceMockRecorder) Get(property interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
